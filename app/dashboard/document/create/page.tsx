...
export default function DocumentCreateRoute() {
    ...
    const [errors, setErrors] = useState<{ customFileName?: string; selectedFile?: string }>({});
    ...
    async function handleSubmit(e: ChangeEvent<HTMLFormElement>) {
        ...
        const validationResult = fileUploadSchema.safeParse({ customFileName, selectedFile });
    ...
    function handleRemoveFile() {
        setSelectedFile(null);
        setErrors((prevErrors) => ({ ...prevErrors, selectedFile: 'Um documento válido deve ser selecionado' }));
    }
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) => {
                            ...
                            setErrors((prevErrors) => ({ ...prevErrors, customFileName: undefined }));
                        }}
